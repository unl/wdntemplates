	...
	var Plugin = {
        ...
        shareButtonTemplate:'<div class="wdn-share-button">'+ // add string to use as template for all share buttons
                                ...
                                '<ul id="wdn_share_{{id}}" class="wdn-share-options wdn-hang-{{hang}} wdn-dropdown-widget-content">'+
                                    ...
                                    '<li class="outpost wdn_facebook"><a href="https://www.facebook.com/sharer/sharer.php?u={{encodedUrl}}" rel="nofollow"><span class="wdn-icon-facebook" aria-hidden="true">Share on Facebook</a></li>'+ // https://developers.facebook.com/docs/plugins/share-button
