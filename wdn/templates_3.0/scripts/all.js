...
//wdn
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('6 4=5(){f{J:{},I:\'\',k:5(b,g,16,X){8((1c.9>2&&16===1a)||!4.J[b]){4.m("1l 15 B: "+b);6 e=d.1b("Q");e.13(\'1h\',4.I+b);e.13(\'K\',\'W/1u\');d.T(\'U\').1v(0).L(e);g=g||5(){};6 C=5(){4.J[b]=1w;4.m("1m 15 B 10: "+b);g()};e.1t=5(){8(e.11=="18"||e.11=="1s"){C()}};e.1o=C}H{4.m("B 10 1n 18: "+b);8((1c.9>3&&X===1a)||!g){f}g()}},R:5(b){6 e=d.1b("o");e.1x=4.I+b;e.1r="1q";e.K="W/r";d.T("U")[0].L(e)},1y:5(){4.R(\'h/l.0/r/Q.r\');4.k(\'h/l.0/v/1e.q\');4.k(\'h/l.0/v/1d.q\');4.k(\'h/l.0/v/1f.q\',4.O)},O:5(){n.1j();n(d).1i(5(){4.j(\'1g\');4.j(\'1k\');4.j(\'1p\');4.N();4.j(\'1G\')})},m:5(P){1W{1Y.m(P)}2a(e){}},N:5(){n(\'#1Z p.M, #21 p.M\').1U(5(i){8(n(V).1V()>20){n(V).r({22:\'23 28 #1z\',29:\'0\'})}})},j:5(G){4.k(\'h/l.0/v/\'+G+\'.q\',5(){27(\'4.\'+G+\'.26();\')})},24:5(y,19,F){8(F){6 t=25 1X();t.1S(t.1F()+(F*1T));6 w=";w="+t.1H()}H{6 w=""}d.17=y+"="+19+w+";1E=/;1D=.1A.1B"},1C:5(y){6 A=y+"=";6 z=d.17.x(\';\');E(6 i=0;i<z.9;i++){6 c=z[i];1I(c.1J(0)==\' \')c=c.Y(1,c.9);8(c.1P(A)==0)f c.Y(A.9,c.9)}f 1Q},1R:5(o,1O){6 7=o.x(\'/\');8(/1N:|1K:|1L:/.1M(7[0])){f o}6 i,a=D.x(\'/\');8(a.9>3){a.14()}8(7[0]===\'\'){D=a[0]+\'//\'+a[2];a=D.x(\'/\');s 7[0]}E(i=0;i<7.9;i++){8(7[i]===\'..\'){8(12 7[i-1]!==\'Z\'){s 7[i-1]}H 8(a.9>3){a.14()}s 7[i]}8(7[i]===\'.\'){s 7[i]}}6 u=[];E(i=0;i<7.9;i++){8(12 7[i]!==\'Z\'){u[u.9]=7[i]}}f a.S(\'/\')+\'/\'+u.S(\'/\')}}}();',62,135,'||||WDN|function|var|lparts|if|length|hparts|url||document||return|callback|wdn||initializePlugin|loadJS|templates_3|log|jQuery|link||js|css|delete|date|newlinkparts|scripts|expires|split|name|ca|nameEQ|JS|executeCallback|host|for|seconds|plugin|else|template_path|loadedJS|type|appendChild|caption|contentAdjustments|jQueryUsage|data|script|loadCSS|join|getElementsByTagName|head|this|text|callbackIfLoaded|substring|undefined|file|readyState|typeof|setAttribute|pop|loading|checkLoaded|cookie|loaded|value|false|createElement|arguments|global_functions|xmlhttp|jquery|navigation|src|ready|noConflict|search|begin|finished|already|onload|feedback|stylesheet|rel|complete|onreadystatechange|javascript|item|true|href|initializeTemplate|ededed|unl|edu|getCookie|domain|path|getTime|toolbar|toGMTString|while|charAt|https|ftp|test|http|base_url|indexOf|null|toAbs|setTime|1000|each|height|try|Date|console|maincontent||footer|border|1px|setCookie|new|initialize|eval|solid|marginleft|catch'.split('|'),0,{}))
//xmlhttp
...
//toolbar_webcams
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('D.E=k(){d n=\'8://9.5.4/1/2/q.3\';d u=\'8://9.5.4/1/2/r.3\';d A=\'8://9.5.4/1/2/x.3\';d m=F;y{C:k(){B(m){y s}M(\'#L\').K(\'<0 c="J"><0 7="h"><6>g b H</6><f 7="j" a="8://9.5.4/1/2/q.3" l="I o" c="z" /></0><0 7="h"><6>g b p</6><f 7="j" a="8://9.5.4/1/2/r.3" l="p o" c="v" /></0><0 7="h"><6>g t b</6><f 7="j" a="8://9.5.4/1/2/x.3" l="t b" c="w" /></0></0>\');m=s},G:k(){i.e(\'z\').a=n;i.e(\'v\').a=u;i.e(\'w\').a=A}}}();',49,49,'div|unlpub|cam|jpg|edu|unl|h3|class|http|www|src|Union|id|var|getElementById|img|Nebraska|col|document|frame|function|alt|initialized|unlwebcam|Cam|Rotunda|cam1|cam2|true|East|rotundawebcam|webcamuri2|webcamuri3|cam3|return|webcamuri1|NEUwebcam|if|initialize|WDN|toolbar_webcams|false|display|Plaza|Plaze|cameracontent|append|toolbarcontent|jQuery'.split('|'),0,{}))
