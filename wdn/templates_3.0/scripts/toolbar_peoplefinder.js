    ...
    return {
        ...
        queuePFRequest : function(q,resultsdiv) {
        	...
        	if (q.length > 3) {
        		...
        		document.getElementById("pfprogress").src = 'wdn/templates_3.0/css/images/transpixel.gif';
        		document.getElementById(pfresultsdiv).innerHTML = defaultIntro;
        	}
        },
