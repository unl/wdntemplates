...
Modernizr.selectorSupported = function(selector) {
    var support, result, link, sheet, doc = document,
...
Modernizr.addTest('checked', function(){
    ...
    return injectElementWithStyles('#modernizr {position:absolute} #modernizr input {margin-left:10px} #modernizr :checked {margin-left:20px;display:block}', function(elem, rule){
