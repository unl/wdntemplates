...
* License: MIT
*
*/var mejs=mejs||{};(function(mejs,jQuery){mejs.version="2.12.0";mejs.meIndex=0;
...
function(){f.ajax({dataType:"html",url:e,success:function(d){c.find(".mejs-postroll-layer-content").html(d)}});a.postroll.show()},false)}}})})(mejs.$);})(mejs,WDN.jQuery);
