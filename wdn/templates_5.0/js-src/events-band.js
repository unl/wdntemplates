define([
    ...
    var fetchEvents = function(localConfig) {
        var upcoming = 'upcoming/',
            ...
            eventList.classList.add('unl-event-teaser-list', 'dcf-list-bare', 'dcf-grid-halves@sm', 'dcf-grid-thirds@lg', 'dcf-col-gap-vw', 'dcf-row-gap-6', 'dcf-mb-0');
