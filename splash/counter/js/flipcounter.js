 ...
 *
 * THIS VERSION CONTAINS UNL MODIFICATIONS TO ADJUST FOR REDUCED IMAGE SIZES
 */
...
var flipCounter = function(d, options){
	...
	function animateDigit(n, oldDigit, newDigit){
		...
		bp = [
			'-' + o.fW + 'px -' + (oldDigit * o.tFH + unlbump('top', oldDigit)) + 'px',
			(o.fW * -2) + 'px -' + (oldDigit * o.tFH + unlbump('top', oldDigit)) + 'px',
			'0 -' + (newDigit * o.tFH + unlbump('top', newDigit)) + 'px',
			'-' + o.fW + 'px -' + (oldDigit * o.bFH + o.bOffset + unlbump('bottom', oldDigit)) + 'px',
			(o.fW * -2) + 'px -' + (newDigit * o.bFH + o.bOffset + unlbump('bottom', newDigit)) + 'px',
			(o.fW * -3) + 'px -' + (newDigit * o.bFH + o.bOffset + unlbump('bottom', newDigit)) + 'px',
			'0 -' + (newDigit * o.bFH + o.bOffset + unlbump('bottom', newDigit)) + 'px'
		];
	...
	function addDigit(len, digit){
		...
		doc.getElementById(divId + "_t_d" + li).style.backgroundPosition = '0 -' + (digit * o.tFH + unlbump('top', digit)) + 'px';
		doc.getElementById(divId + "_b_d" + li).style.backgroundPosition = '0 -' + (digit * o.bFH + o.bOffset + unlbump('bottom', digit)) + 'px';
	}
	...
	function initialDigitCheck(init){
		...
		for (i = 0; i < count; i++){
			doc.getElementById(divId + "_t_d" + i).style.backgroundPosition = '0 -' + (digits[i] * o.tFH + unlbump('top', digits[i])) + 'px';
			doc.getElementById(divId + "_b_d" + i).style.backgroundPosition = '0 -' + (digits[i] * o.bFH + o.bOffset + unlbump('bottom', digits[i])) + 'px';
		}
		// Do first animation
		if (o.auto === true) nextCount = setTimeout(doCount, o.pace);
	}
	...
	function unlbump(pos, digit) {
		var unlbumptop, unlbumpbottom = 0;
		if (digit == 0) {
			unlbumptop = 0;
			unlbumpbottom = -1;
		} else if (digit == 1) {
