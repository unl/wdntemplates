...
<html lang="en">
    ...
    <body class="@@(_document['class'])@@ unl app" data-version="$HTML_VERSION$" data-template="app-cloud">
        ...
        <header class="dcf-header" id="dcf-header" role="banner">
            ...
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/local/app-controls.html"); ?>
            <!-- TemplateEndEditable -->
            ...
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/global/app-search-1.html"); ?>
            <!-- TemplateBeginEditable name="appsearch" -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/local/app-search.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/global/app-search-2.html"); ?>
        </header>
