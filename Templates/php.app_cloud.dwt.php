...
<html lang="en">
    ...
    <body class="unl app" data-version="$HTML_VERSION$" data-template="app-cloud">
        ...
        <header class="dcf-header" id="dcf-header" role="banner">
            ...
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/cta-header-1.html"); ?>
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/visit-header-1.html"); ?>
            <!-- InstanceBeginEditable name="headervisit" -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/local/visit-local.html"); ?>
            <!-- InstanceEndEditable -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/visit-header-2.html"); ?>
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/apply-header-1.html"); ?>
            <!-- InstanceBeginEditable name="headerapply" -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/local/apply-local.html"); ?>
            <!-- InstanceEndEditable -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/apply-header-2.html"); ?>
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/give-header-1.html"); ?>
            <!-- InstanceBeginEditable name="headergive" -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/local/give-local.html"); ?>
            <!-- InstanceEndEditable -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/give-header-2.html"); ?>
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/cta-header-2.html"); ?>
            ...
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/local/app-controls.html"); ?>
            <!-- TemplateEndEditable -->
            ...
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/app-search-1.html"); ?>
            <!-- TemplateBeginEditable name="appsearch" -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/local/app-search.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.1/includes/global/app-search-2.html"); ?>
        </header>
