...
<html lang="en">
    <head>
        ...
        <!-- TemplateEndEditable -->
        <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/global/affiliate-head-2.html"); ?>
    ...
    <body class="@@(_document['class'])@@ unl affiliate" data-version="$HTML_VERSION$" data-template="affiliate-cloud">
        ...
        <header class="dcf-header" id="dcf-header" role="banner">
            ...
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/local/affiliate-header-global-1.html"); ?>
            <!-- TemplateEndEditable -->
            <!-- TemplateBeginEditable name="affiliateidm" -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/local/affiliate-idm.html"); ?>
            <!-- TemplateEndEditable -->
            <!-- TemplateBeginEditable name="affiliatesearch" -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/local/affiliate-search.html"); ?>
            <!-- TemplateEndEditable -->
            ...
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/local/affiliate-logo-lockup-1.html"); ?>
            <!-- TemplateEndEditable -->
            ...
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/global/affiliate-nav-toggle-group-1.html"); ?>
            <!-- TemplateBeginEditable name="affiliatemobilesearch" -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/local/affiliate-mobile-search.html"); ?>
            <!-- TemplateEndEditable -->
            <!-- TemplateBeginEditable name="affiliatemobileidm" -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/local/affiliate-mobile-idm.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/global/affiliate-nav-toggle-group-2.html"); ?>
        ...
        <footer class="dcf-footer" id="dcf-footer" role="contentinfo">
            ...
            <?php wdnInclude("https://wdn-cdn.unl.edu/wdn/templates_6.0/includes/local/affiliate-footer.html"); ?>
            <!-- TemplateEndEditable -->
