...
<header class="dcf-header" id="dcf-header" role="banner">
  ...
  <c:import url="https://unlcms.unl.edu/wdn/templates_5.0/includes/global/nav-toggle-btn.html"/>
  <c:import url="https://unlcms.unl.edu/wdn/templates_5.0/includes/global/nav-menu-child-1.html"/>
  <!-- TemplateBeginEditable name="navlinks" -->
  <c:import url="https://unlcms.unl.edu/wdn/templates_5.0/includes/local/nav-local.html"/>
  <!-- TemplateEndEditable -->
  <c:import url="https://unlcms.unl.edu/wdn/templates_5.0/includes/global/nav-menu-child-2.html"/>
