...
<head>
<c:import url="/wdn/templates_4.1/includes/metanfavico_local.html"/>
<!--
    ...
    $Id$
-->
<c:import url="/wdn/templates_4.1/includes/scriptsandstyles_local.html"/>
...
<body class="@@(_document['class'])@@" data-version="$HTML_VERSION$">
    <c:import url="/wdn/templates_4.1/includes/skipnav.html"/>
    <div id="wdn_wrapper">
        <input type="checkbox" id="wdn_menu_toggle" value="Show navigation menu" class="wdn-content-slide wdn-input-driver" />
        <c:import url="/wdn/templates_4.1/includes/noscript-padding.html"/>
        <header id="header" role="banner" class="wdn-content-slide wdn-band">
            <div id="wdn_header_top">
                ...
                <div id="wdn_resources">
                    <c:import url="/wdn/templates_4.1/includes/wdnResources.html"/>
                    <c:import url="/wdn/templates_4.1/includes/idm.html"/>
                    <c:import url="/wdn/templates_4.1/includes/search.html"/>
                </div>
            </div>
            <div id="wdn_logo_lockup">
                <div class="wdn-inner-wrapper">
                    <c:import url="/wdn/templates_4.1/includes/logo.html"/>
        ...
        <div id="wdn_navigation_bar" class="wdn-band">
            ...
            <div id="wdn_navigation_wrapper">
                <nav id="navigation" role="navigation" aria-label="main navigation">
                    ...
                    <!-- TemplateEndEditable -->
                    <c:import url="/wdn/templates_4.1/includes/navigation-addons.html"/>
                </nav>
            </div>
        </div>
        <div class="wdn-menu-trigger wdn-content-slide">
            <label for="wdn_menu_toggle" class="wdn-icon-menu">Menu</label>
            <c:import url="/wdn/templates_4.1/includes/share.html"/>
        </div>
        ...
        <footer id="footer" role="contentinfo" class="wdn-content-slide">
            ...
            <div id="wdn_global_footer" class="wdn-band wdn-footer-global">
                <div class="wdn-inner-wrapper">
                   <c:import url="/wdn/templates_4.1/includes/globalfooter.html"/>
                </div>
            </div>
        </footer>
        <c:import url="/wdn/templates_4.1/includes/noscript.html"/>
    </div>
    <c:import url="/wdn/templates_4.1/includes/body_scripts.html"/>
</body>
</html>
