...
<html class="dcf-no-js dcf-no-webp" lang="en">
  ...
  <body class="@@(_document['class'])@@ affiliate" data-version="$HTML_VERSION$">
    ...
    <header class="dcf-header" id="dcf-header" role="banner">
      ...
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.2/includes/global/nav-toggle-btn.html"/>
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.2/includes/global/nav-menu-child-1.html"/>
      <!-- InstanceBeginEditable name="navlinks" -->
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.2/includes/local/nav-local.html"/>
      <!-- InstanceEndEditable -->
      ...
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.2/includes/global/nav-menu-child-2.html"/>
