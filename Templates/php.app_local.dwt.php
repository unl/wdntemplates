...
<html lang="en">
    <head>
        ...
        <!-- TemplateEndEditable -->
        <?php wdnInclude("/wdn/templates_6.1/includes/global/head-2-local.html"); ?>
    ...
    <body class="unl app" data-version="$HTML_VERSION$" data-template="app-local">
        ...
        <header class="dcf-header" id="dcf-header" role="banner">
            ...
            <?php wdnInclude("/wdn/templates_6.1/includes/global/logo-lockup-1.html"); ?>
            ...
            <?php wdnInclude("/wdn/templates_6.1/includes/global/nav-toggle-group.html"); ?>
            ...
            <?php wdnInclude("/wdn/templates_6.1/includes/local/app-controls.html"); ?>
            <!-- TemplateEndEditable -->
            ...
            <?php wdnInclude("/wdn/templates_6.1/includes/local/app-search.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/app-search-2.html"); ?>
        </header>
        ...
        <footer class="dcf-footer" id="dcf-footer" role="contentinfo">
            ...
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/footer-global-1.html"); ?>
            <!-- TemplateBeginEditable name="contactinfo" -->
            <?php wdnInclude("/wdn/templates_6.1/includes/local/footer-local.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/footer-global-2.html"); ?>
            <?php wdnInclude("/wdn/templates_6.1/includes/global/footer-global-3-std.html"); ?>
