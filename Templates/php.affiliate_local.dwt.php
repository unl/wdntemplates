...
<html lang="en">
    <head>
        <?php wdnInclude("/wdn/templates_6.1/includes/global/head-1.html"); ?>
        <!--
        ...
        <!-- TemplateEndEditable -->
        <?php wdnInclude("/wdn/templates_6.1/includes/global/affiliate-head-2-local.html"); ?>
        <!-- TemplateBeginEditable name="head" -->
        <!-- Place optional header elements here -->
        <link rel="stylesheet" href="/wdn/templates_6.1/includes/local/affiliate-custom.css">
        <link rel="icon" href="/wdn/templates_6.1/includes/global/favicon/favicon.ico" sizes="any">
        <link rel="icon" href="/wdn/templates_6.1/includes/global/favicon/icon.svg" type="image/svg+xml">
        <link rel="apple-touch-icon" href="/wdn/templates_6.1/includes/global/favicon/apple-touch-icon.png">
        <link rel="manifest" href="/wdn/templates_6.1/includes/global/favicon/manifest.webmanifest">
        <meta name="theme-color" content="#d00000">
        <!-- TemplateEndEditable -->
    </head>
    <body class="unl afilliate" data-version="$HTML_VERSION$" data-template="affiliate-local">
        <?php wdnInclude("/wdn/templates_6.1/includes/global/skip-nav.html"); ?>
        <header class="dcf-header" id="dcf-header" role="banner">
            <!-- TemplateBeginEditable name="affiliateheaderglobal" -->
            <?php wdnInclude("/wdn/templates_6.1/includes/local/affiliate-header-global-1.html"); ?>
            <!-- TemplateEndEditable -->
            <!-- TemplateBeginEditable name="affiliateidm" -->
            <?php wdnInclude("/wdn/templates_6.1/includes/local/affiliate-idm.html"); ?>
            <!-- TemplateEndEditable -->
            <!-- TemplateBeginEditable name="affiliatesearch" -->
            <?php wdnInclude("/wdn/templates_6.1/includes/local/affiliate-search.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/header-global-2.html"); ?>
            <!-- TemplateBeginEditable name="affiliatelogo" -->
            <?php wdnInclude("/wdn/templates_6.1/includes/local/affiliate-logo-lockup-1.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/site-affiliation-1.html"); ?>
            <!-- TemplateBeginEditable name="affiliation" -->
            <a href="#">My site affiliation</a>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/site-affiliation-2.html"); ?>
            <?php wdnInclude("/wdn/templates_6.1/includes/global/site-title-1.html"); ?>
            <!-- TemplateBeginEditable name="titlegraphic" -->
            <a class="dcf-txt-h6" href="#">Title of my site</a>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/site-title-2.html"); ?>
            <?php wdnInclude("/wdn/templates_6.1/includes/global/logo-lockup-2.html"); ?>
            <?php wdnInclude("/wdn/templates_6.1/includes/global/nav-container-1.html"); ?>
            <?php wdnInclude("/wdn/templates_6.1/includes/global/affiliate-nav-toggle-group-1.html"); ?>
            <!-- TemplateBeginEditable name="affiliatemobilesearch" -->
            <?php wdnInclude("/wdn/templates_6.1/includes/local/affiliate-mobile-search.html"); ?>
            <!-- TemplateEndEditable -->
            <!-- TemplateBeginEditable name="affiliatemobileidm" -->
            <?php wdnInclude("/wdn/templates_6.1/includes/local/affiliate-mobile-idm.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/affiliate-nav-toggle-group-2.html"); ?>
            <?php wdnInclude("/wdn/templates_6.1/includes/global/nav-menu-1.html"); ?>
            <?php wdnInclude("/wdn/templates_6.1/includes/global/nav-local-1.html"); ?>
            <!-- TemplateBeginEditable name="navlinks" -->
            <?php wdnInclude("/wdn/templates_6.1/includes/local/nav-local.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/nav-local-2.html"); ?>
        ...
        <footer class="dcf-footer" id="dcf-footer" role="contentinfo">
            ...
            <?php wdnInclude("/wdn/templates_6.1/includes/local/affiliate-footer.html"); ?>
            <!-- TemplateEndEditable -->
            <?php wdnInclude("/wdn/templates_6.1/includes/global/noscript.html"); ?>
        </footer>
        <?php wdnInclude("/wdn/templates_6.1/includes/global/js-body-local.html"); ?>
