...
<html class="dcf-no-js dcf-no-webp" lang="en">
  <head>
    <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/global/head-1.html"/>
    <!--
  ...
  <body class="@@(_document['class'])@@ unl app" data-version="$HTML_VERSION$">
    ...
    <header class="dcf-header" id="dcf-header" role="banner">
      ...
      <!-- TemplateEndEditable -->
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/global/site-affiliation-2.html"/>
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/global/site-title-1.html"/>
      ...
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/global/nav-menu-child-app-1.html"/>
      <!-- TemplateBeginEditable name="appcontrols" -->
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/local/app-controls.html"/>
      <!-- TemplateEndEditable -->
      ...
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/global/nav-menu-child-app-2.html"/>
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/global/nav-menu-2.html"/>
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/global/app-search-1.html"/>
      <!-- TemplateBeginEditable name="appsearch" -->
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/local/app-search.html"/>
      <!-- TemplateEndEditable -->
      <c:import url="https://unlcms.unl.edu/wdn/templates_5.3/includes/global/app-search-2.html"/>
    </header>
