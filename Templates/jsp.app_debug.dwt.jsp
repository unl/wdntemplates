...
<html class="dcf-no-js dcf-no-webp" lang="en">
  <head>
    <c:import url="/wdn/templates_5.3/includes/global/head-1.html"/>
    <!--
      Membership and regular participation in the University of Nebraska&ndash;Lincoln (UNL) Web Developer Network (WDN) is required to use the UNLedu Web Framework. Visit the WDN site at https://wdn.unl.edu/. Register for our mailing list and add your site or server to UNL Web Audit.
    ...
    <!-- TemplateEndEditable -->
    <c:import url="/wdn/templates_5.3/includes/global/head-2-local.html"/>
  ...
  <body class="@@(_document['class'])@@ unl app" data-version="$HTML_VERSION$">
    ...
    <header class="dcf-header" id="dcf-header" role="banner">
      ...
      <c:import url="/wdn/templates_5.3/includes/global/search.html"/>
      ...
      <c:import url="/wdn/templates_5.3/includes/global/nav-menu-child-app-1.html"/>
      <!-- TemplateBeginEditable name="appcontrols" -->
      <c:import url="/wdn/templates_5.3/includes/local/app-controls.html"/>
      <!-- TemplateEndEditable -->
      ...
      <c:import url="/wdn/templates_5.3/includes/global/nav-menu-child-app-2.html"/>
      <c:import url="/wdn/templates_5.3/includes/global/nav-menu-2.html"/>
      <c:import url="/wdn/templates_5.3/includes/global/app-search-1.html"/>
      <!-- TemplateBeginEditable name="appsearch" -->
      <c:import url="/wdn/templates_5.3/includes/local/app-search.html"/>
      <!-- TemplateEndEditable -->
      <c:import url="/wdn/templates_5.3/includes/global/app-search-2.html"/>
    </header>
    ...
    <footer class="dcf-footer" id="dcf-footer" role="contentinfo">
      ...
      <!-- TemplateEndEditable -->
      <c:import url="/wdn/templates_5.3/includes/global/footer-global-1.html"/>
      <!-- TemplateBeginEditable name="contactinfo" -->
      <c:import url="/wdn/templates_5.3/includes/local/footer-local.html"/>
      <!-- TemplateEndEditable -->
      <c:import url="/wdn/templates_5.3/includes/global/footer-global-2.html"/>
      <c:import url="/wdn/templates_5.3/includes/global/noscript.html"/>
    </footer>
    <c:import url="/wdn/templates_5.3/includes/global/js-body-local.html"/>
